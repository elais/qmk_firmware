...
[BASE] = LAYOUT_ergodox( // layer 0 : default
  // left hand
  LT(NAV,KC_ESC),    KC_F1,   KC_F2,      KC_F3,    KC_F4,    KC_F5, KC_DELETE,
  KC_TAB,            KC_Q,    KC_W,       KC_E,     KC_R,     KC_T,  OSL(TOP),
  CTL_T(KC_DELETE),  KC_A,    KC_S,       KC_D,     KC_F,     KC_G,
  KC_LSFT,           KC_Z,    KC_X,       KC_C,     KC_V,     KC_B,  KC_MEH,
  MOD_HYPR,          KC_LGUI, KC_LALT,    KC_LCTRL,  MO(NAV),
                                        C(KC_LALT),          RGB_M_K,
                                                             MO(NAV),
                          LT(SYMB, KC_ENT), LT(NAV,KC_ESC), KC_LSFT,
  // right hand
  KC_BSPC,         KC_F6,   KC_F7,   KC_F8,    KC_F9,    KC_F10,   KC_BSLS,
...
[SYMB] = LAYOUT_ergodox(
 ...
 LSFT(KC_QUOT),  KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,
       ...
       KC_PPLS,  KC_BSLS,  KC_7,     KC_8,     KC_9,     KC_ASTR,     KC_TRNS,
                 KC_MINUS, KC_4,     KC_5,     KC_6,     KC_PLUS,     KC_TRNS,
       KC_PEQL,  KC_AMPR,  KC_1,     KC_2,     KC_3,     KC_PEQL,     KC_TRNS,
